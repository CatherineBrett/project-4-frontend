        ...
        <div className="hero-body pb-0">
          <div className="columns">
            ...
            <div className="column is-one-third">
              <h1 className="title has-text-success has-text-centered is-size-1">
                Harborne Community Groups
              </h1>
              <p className="is-size-5 has-text-grey-dark has-text-centered mb-4">
              ...
              <p className="is-size-5 has-text-grey-dark has-text-centered">
                ...
                you will need to <Link to="/signup">sign up</Link> for an
                account, or <Link to="/login">log in</Link> if you have an
                account already.
              </p>
            </div>
